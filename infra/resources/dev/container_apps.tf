...
#   virtual_network                      = azurerm_virtual_network.vnet_common_itn
#   subnet_cidr                          = "10.20.8.128/25"
#   subnet_pep_id                        = azurerm_subnet.pep.id
#   private_dns_zone_resource_group_name = azurerm_resource_group.weu_common.name

#   log_analytics_workspace_id = azurerm_log_analytics_workspace.common.id

#   key_vault_id = azurerm_key_vault.plsm-kv.id
